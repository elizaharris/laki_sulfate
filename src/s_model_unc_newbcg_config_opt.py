...
#%% TO DO:
# - Add a match to the sulfate concentration (normalised) in the depth-time match part
# - Make this an option at the start so you can select if you want to match to which variables [d34S, d33S, D33S, sulfate]

# Change initial SO2 to 0.5 permil (from Tephra)
